import { type VehicleServiceType } from './supabase';
...
export const SERVICE_TYPES: ServiceTypeDefinition[] = [
  {
    ...
    tag: 'text-emerald-600 bg-emerald-500/10 border-emerald-500/20',
    steps: [
  ...
  },
  {
    ...
    accent: 'border-l-brand-primary',
    tag: 'text-sky-600 bg-sky-500/10 border-sky-500/20',
    steps: [
  ...
  },
  {
    ...
    accent: 'border-l-brand-primary',
    tag: 'text-amber-600 bg-amber-500/10 border-amber-500/20',
    steps: [
  ...
  },
  {
    ...
    accent: 'border-l-brand-primary',
    tag: 'text-destructive bg-destructive/10 border-destructive/20',
    steps: [
