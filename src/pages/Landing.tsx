  ...
  return (
    <div className="max-w-screen-2xl mx-auto px-6 sm:px-8 py-10 sm:py-14">
      ...
      <section className="mb-12">
        <h1 className="text-3xl sm:text-5xl font-black tracking-tight text-zinc-900 dark:text-zinc-50 max-w-3xl leading-[1.1]">
          Welcome to DetailFox Pro
        </h1>
        <p className="mt-3 text-base sm:text-lg text-zinc-500 dark:text-zinc-400 max-w-2xl leading-relaxed">
      ...
      <section>
        <div className="flex items-center gap-2 mb-5">
          <h2 className="text-sm font-bold uppercase tracking-widest text-zinc-900 dark:text-zinc-50">
            My tools
          </h2>
        ...
        <div className="grid gap-4 sm:grid-cols-2 max-w-4xl">
          {/* DetailPace */}
          <div className="relative bg-white border border-zinc-200 border-l-4 border-l-orange-500 overflow-hidden transition-colors hover:border-zinc-300 dark:bg-zinc-900 dark:border-zinc-700 dark:hover:border-zinc-600">
            <div className="p-5">
              <div className="flex items-start justify-between gap-3 mb-4">
                ...
                <div className="flex items-center justify-center w-9 h-9 bg-zinc-900 text-white dark:bg-zinc-100 dark:text-zinc-900">
                  <Clock className="w-4 h-4" />
                </div>
              </div>

              <div className="flex flex-wrap gap-1.5 mb-4">
                <span className="text-xs font-bold px-2 py-0.5 border uppercase tracking-wider text-emerald-700 bg-emerald-50 border-emerald-200 dark:text-emerald-300 dark:bg-emerald-950 dark:border-emerald-800">
                  Available
                </span>
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 bg-black hover:bg-zinc-800 text-white font-bold text-sm uppercase tracking-widest py-3 transition-colors dark:bg-zinc-100 dark:text-zinc-900 dark:hover:bg-zinc-200"
              >
                Open app
