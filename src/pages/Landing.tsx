  ...
  return (
    <div className="max-w-screen-2xl mx-auto px-6 sm:px-8 py-10 sm:py-14">
      ...
      <section className="mb-12">
        <h1 className="text-3xl sm:text-5xl font-black tracking-tight text-foreground-primary max-w-3xl leading-[1.1]">
      ...
      <section>
        <div className="flex items-center gap-2 mb-5">
          <h2 className="text-sm font-bold uppercase tracking-widest text-foreground-primary">
            My tools
          </h2>
        ...
        <div className="grid gap-4 sm:grid-cols-2 max-w-4xl">
          {/* DetailPace */}
          <div className="relative bg-background-surface border border-border-default border-l-4 border-l-brand-primary overflow-hidden transition-colors hover:border-border-subtle">
            <div className="p-5">
              ...
              <div className="flex flex-wrap gap-1.5 mb-4">
                <span className="text-xs font-bold px-2 py-0.5 border uppercase tracking-wider text-brand-success bg-background-surface border-border-default">
                  Available
                </span>
              ...
              <p className="text-foreground-tertiary text-sm mb-5">
